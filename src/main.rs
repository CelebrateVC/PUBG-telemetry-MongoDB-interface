...
use crate::compostites::{LogGameStatePeriodic,LogHeal,LogItemAttach,
...
async fn main() -> io::Result<()>{
    ...
    let map: HashMap<String,api::MyAwesomeInnerDataContainer<compostites::Minimal>> = HashMap::from(
        [
